                  ...
                  child: GridView.count(
                    ...
                    children: [
                      if (user?['role'] == 'student') ...[
                        ...
                        _QuickItem(icon: Iconsax.chart_2, label: 'Grades', accent: accent, muted: muted, onTap: () {}),
                        ...
                        _QuickItem(icon: Iconsax.calendar_1, label: 'Schedule', accent: accent, muted: muted, onTap: () {}),
                        _QuickItem(icon: Iconsax.message_question, label: 'FAQ', accent: accent, muted: muted, onTap: () {}),
                        _QuickItem(icon: Iconsax.book, label: 'Courses', accent: accent, muted: muted, onTap: () {}),
                        _QuickItem(icon: Iconsax.archive, label: 'Sections', accent: accent, muted: muted, onTap: () {}),
                        ...
                        _QuickItem(icon: Iconsax.calendar_1, label: 'Schedule', accent: accent, muted: muted, onTap: () {}),
                        _QuickItem(icon: Iconsax.message_question, label: 'FAQ', accent: accent, muted: muted, onTap: () {}),
                        _QuickItem(icon: Iconsax.award, label: 'Credits', accent: accent, muted: muted, onTap: () {}),
                        _QuickItem(icon: Iconsax.clipboard_tick, label: 'Claims', accent: accent, muted: muted, onTap: () {}),
                        _QuickItem(icon: Iconsax.chart_2, label: 'Reports', accent: accent, muted: muted, onTap: () {}),
                        _QuickItem(icon: Iconsax.setting_2, label: 'Settings', accent: accent, muted: muted, onTap: () {}),
                      ] else ...[
                        _QuickItem(icon: Iconsax.ticket_discount, label: 'e-Kupon', accent: accent, muted: muted, onTap: () {}),
